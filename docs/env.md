...
| VM_OPERATOR_VERSION: `v0.70.1` <a href="#variables-vm-operator-version" id="variables-vm-operator-version">#</a> |
...
| VM_USE_OLD_BACKUP_RESTORE_PORT_NAMES: `false` <a href="#variables-vm-use-old-backup-restore-port-names" id="variables-vm-use-old-backup-restore-port-names">#</a><br>Restores old VMBackup/VMRestore port names to avoid restarts during upgrades |
...
| VM_VLOGSDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlogsdefault-termination-grace-period-seconds" id="variables-vm-vlogsdefault-termination-grace-period-seconds">#</a> |
...
| VM_VLAGENTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlagentdefault-termination-grace-period-seconds" id="variables-vm-vlagentdefault-termination-grace-period-seconds">#</a> |
...
| VM_VLSINGLEDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlsingledefault-termination-grace-period-seconds" id="variables-vm-vlsingledefault-termination-grace-period-seconds">#</a> |
...
| VM_VTSINGLEDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vtsingledefault-termination-grace-period-seconds" id="variables-vm-vtsingledefault-termination-grace-period-seconds">#</a> |
...
| VM_VMALERTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmalertdefault-termination-grace-period-seconds" id="variables-vm-vmalertdefault-termination-grace-period-seconds">#</a> |
...
| VM_VMAGENTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmagentdefault-termination-grace-period-seconds" id="variables-vm-vmagentdefault-termination-grace-period-seconds">#</a> |
...
| VM_VMANOMALYDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmanomalydefault-termination-grace-period-seconds" id="variables-vm-vmanomalydefault-termination-grace-period-seconds">#</a> |
...
| VM_VMSINGLEDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmsingledefault-termination-grace-period-seconds" id="variables-vm-vmsingledefault-termination-grace-period-seconds">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMSELECTDEFAULT_USEDEFAULTRESOURCES: `${VM_VMCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vmclusterdefault-vmselectdefault-usedefaultresources" id="variables-vm-vmclusterdefault-vmselectdefault-usedefaultresources">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMSELECTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmclusterdefault-vmselectdefault-termination-grace-period-seconds" id="variables-vm-vmclusterdefault-vmselectdefault-termination-grace-period-seconds">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMSTORAGEDEFAULT_USEDEFAULTRESOURCES: `${VM_VMCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vmclusterdefault-vmstoragedefault-usedefaultresources" id="variables-vm-vmclusterdefault-vmstoragedefault-usedefaultresources">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMSTORAGEDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmclusterdefault-vmstoragedefault-termination-grace-period-seconds" id="variables-vm-vmclusterdefault-vmstoragedefault-termination-grace-period-seconds">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMINSERTDEFAULT_USEDEFAULTRESOURCES: `${VM_VMCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vmclusterdefault-vminsertdefault-usedefaultresources" id="variables-vm-vmclusterdefault-vminsertdefault-usedefaultresources">#</a> |
...
| VM_VMCLUSTERDEFAULT_VMINSERTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmclusterdefault-vminsertdefault-termination-grace-period-seconds" id="variables-vm-vmclusterdefault-vminsertdefault-termination-grace-period-seconds">#</a> |
...
| VM_VMALERTMANAGER_TERMINATION_GRACE_PERIOD_SECONDS: `120` <a href="#variables-vm-vmalertmanager-termination-grace-period-seconds" id="variables-vm-vmalertmanager-termination-grace-period-seconds">#</a> |
...
| VM_VMBACKUP_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmbackup-termination-grace-period-seconds" id="variables-vm-vmbackup-termination-grace-period-seconds">#</a> |
...
| VM_VMAUTHDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vmauthdefault-termination-grace-period-seconds" id="variables-vm-vmauthdefault-termination-grace-period-seconds">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLSELECTDEFAULT_USEDEFAULTRESOURCES: `${VM_VLCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vlclusterdefault-vlselectdefault-usedefaultresources" id="variables-vm-vlclusterdefault-vlselectdefault-usedefaultresources">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLSELECTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlclusterdefault-vlselectdefault-termination-grace-period-seconds" id="variables-vm-vlclusterdefault-vlselectdefault-termination-grace-period-seconds">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLSTORAGEDEFAULT_USEDEFAULTRESOURCES: `${VM_VLCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vlclusterdefault-vlstoragedefault-usedefaultresources" id="variables-vm-vlclusterdefault-vlstoragedefault-usedefaultresources">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLSTORAGEDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlclusterdefault-vlstoragedefault-termination-grace-period-seconds" id="variables-vm-vlclusterdefault-vlstoragedefault-termination-grace-period-seconds">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLINSERTDEFAULT_USEDEFAULTRESOURCES: `${VM_VLCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vlclusterdefault-vlinsertdefault-usedefaultresources" id="variables-vm-vlclusterdefault-vlinsertdefault-usedefaultresources">#</a> |
...
| VM_VLCLUSTERDEFAULT_VLINSERTDEFAULT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vlclusterdefault-vlinsertdefault-termination-grace-period-seconds" id="variables-vm-vlclusterdefault-vlinsertdefault-termination-grace-period-seconds">#</a> |
...
| VM_VTCLUSTERDEFAULT_SELECT_USEDEFAULTRESOURCES: `${VM_VTCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vtclusterdefault-select-usedefaultresources" id="variables-vm-vtclusterdefault-select-usedefaultresources">#</a> |
...
| VM_VTCLUSTERDEFAULT_SELECT_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vtclusterdefault-select-termination-grace-period-seconds" id="variables-vm-vtclusterdefault-select-termination-grace-period-seconds">#</a> |
...
| VM_VTCLUSTERDEFAULT_STORAGE_USEDEFAULTRESOURCES: `${VM_VTCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vtclusterdefault-storage-usedefaultresources" id="variables-vm-vtclusterdefault-storage-usedefaultresources">#</a> |
...
| VM_VTCLUSTERDEFAULT_STORAGE_TERMINATION_GRACE_PERIOD_SECONDS: `30` <a href="#variables-vm-vtclusterdefault-storage-termination-grace-period-seconds" id="variables-vm-vtclusterdefault-storage-termination-grace-period-seconds">#</a> |
...
| VM_VTCLUSTERDEFAULT_INSERT_USEDEFAULTRESOURCES: `${VM_VTCLUSTERDEFAULT_USEDEFAULTRESOURCES}` <a href="#variables-vm-vtclusterdefault-insert-usedefaultresources" id="variables-vm-vtclusterdefault-insert-usedefaultresources">#</a> |
