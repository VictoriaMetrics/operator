...
var vmpodscrapesResource = schema.GroupVersionResource{Group: "victoriametrics.com", Version: "v1beta1", Resource: "vmpodscrapes"}

var vmpodscrapesKind = schema.GroupVersionKind{Group: "victoriametrics.com", Version: "v1beta1", Kind: "VMPodScrape"}
...
func (c *FakeVMPodScrapes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vmpodscrapesResource, c.ns, name), &v1beta1.VMPodScrape{})
