...
// +kubebuilder:webhook:path=/mutate-operator-victoriametrics-com-v1beta1-vlogs,mutating=true,failurePolicy=fail,sideEffects=None,groups=operator.victoriametrics.com,resources=vlogs,verbs=create;update,versions=v1beta1,name=vvlogs.kb.io,admissionReviewVersions=v1

var _ webhook.Defaulter = &VLogs{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *VLogs) Default() {
}
