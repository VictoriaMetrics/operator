...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonVMAgentSpec) DeepCopyInto(out *CommonVMAgentSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonVMAgentSpec.
func (in *CommonVMAgentSpec) DeepCopy() *CommonVMAgentSpec {
	if in == nil {
		return nil
	}
	out := new(CommonVMAgentSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VMAgentSpec) DeepCopyInto(out *VMAgentSpec) {
	*out = *in
	in.CommonVMAgentSpec.DeepCopyInto(&out.CommonVMAgentSpec)
