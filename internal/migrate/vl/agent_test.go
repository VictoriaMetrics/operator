...
func TestBufferAgentWriteURL(t *testing.T) {
	assert.Equal(t, "http://x.default.svc:9428/internal/insert", bufferAgentWriteURL("http://x.default.svc:9428/insert/native", ""))
}

func TestBufferAgentWriteURL_PathPrefix(t *testing.T) {
	assert.Equal(t, "http://x.default.svc:9428/foo/internal/insert", bufferAgentWriteURL("http://x.default.svc:9428/insert/native", "/foo"))
}
