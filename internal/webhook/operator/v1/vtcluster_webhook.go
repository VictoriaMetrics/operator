...
func SetupVTClusterWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1.VTCluster{}).
		WithValidator(&VTClusterCustomValidator{}).
		Complete()
}
...
var _ admission.Validator[*vmv1.VTCluster] = (*VTClusterCustomValidator)(nil)

// ValidateCreate implements admission.Validator so a webhook will be registered for the type
func (*VTClusterCustomValidator) ValidateCreate(_ context.Context, obj *vmv1.VTCluster) (admission.Warnings, error) {
	...
	return build.WarnOpenShiftVTClusterSpec(&obj.Spec), nil
}

// ValidateUpdate implements admission.Validator so a webhook will be registered for the type
func (*VTClusterCustomValidator) ValidateUpdate(_ context.Context, _, newObj *vmv1.VTCluster) (admission.Warnings, error) {
	...
	return build.WarnOpenShiftVTClusterSpec(&newObj.Spec), nil
}

// ValidateDelete implements admission.Validator so a webhook will be registered for the type
func (*VTClusterCustomValidator) ValidateDelete(_ context.Context, _ *vmv1.VTCluster) (admission.Warnings, error) {
	return nil, nil
}
