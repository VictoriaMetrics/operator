...
func makePodSpecForVMSelect(cr *vmv1beta1.VMCluster) (*corev1.PodTemplateSpec, error) {
	...
	args = build.AddHTTPShutdownDelayArg(args, cr.Spec.VMSelect.ExtraArgs, cr.Spec.VMSelect.TerminationGracePeriodSeconds, cr.ParsedLastAppliedSpec == nil)
...
func makePodSpecForVMInsert(cr *vmv1beta1.VMCluster) (*corev1.PodTemplateSpec, error) {
	...
	args = build.AddHTTPShutdownDelayArg(args, cr.Spec.VMInsert.ExtraArgs, cr.Spec.VMInsert.TerminationGracePeriodSeconds, cr.ParsedLastAppliedSpec == nil)
...
func makePodSpecForVMStorage(ctx context.Context, cr *vmv1beta1.VMCluster) (*corev1.PodTemplateSpec, error) {
	...
	args = build.AddHTTPShutdownDelayArg(args, cr.Spec.VMStorage.ExtraArgs, cr.Spec.VMStorage.TerminationGracePeriodSeconds, cr.ParsedLastAppliedSpec == nil)
...
func buildVMAuthLBDeployment(cr *vmv1beta1.VMCluster) (*appsv1.Deployment, error) {
	...
	args = build.AddHTTPShutdownDelayArg(args, spec.ExtraArgs, spec.TerminationGracePeriodSeconds, cr.ParsedLastAppliedSpec == nil)
