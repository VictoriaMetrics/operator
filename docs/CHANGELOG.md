...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/operator/resources/vmsingle/) and [vmagent](https://docs.victoriametrics.com/operator/resources/vmagent/): do not mount scrape configuration secret in ingest only mode, when relabelling and stream agregation is enabled. See [#1828](https://github.com/VictoriaMetrics/operator/issues/1828).
