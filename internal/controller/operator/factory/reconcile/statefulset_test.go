...
func Test_performRollingUpdateOnSts(t *testing.T) {
	...
	f := func(o opts) {
		...
		assert.ElementsMatch(t, actions, o.actions)
	}
	...
	f(opts{
		...
		actions: []string{"Evict", "Evict", "Evict", "Get", "Get", "Get"},
	})
	...
	f(opts{
		...
		actions: []string{"Delete", "Get", "Delete", "Get", "Delete", "Get"},
	})
