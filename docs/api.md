...
| `retentionPeriod` | RetentionPeriod for the stored logs<br />Note VictoriaLogs has data/ and indexdb/ folders<br />logs from data/ removed eventually as soon as partition leaves retention period<br />reverse index data at indexdb rotates once at the half of configured [retention period](https://github.com/VictoriaMetrics/VictoriaMetrics/tree/master/docs/Single-server-VictoriaMetrics.md/#retention) | _string_ | true |
...
| `serviceScrapeSpec` | ServiceScrapeSpec that will be added to vmlogs VMServiceScrape spec | _[VMServiceScrapeSpec](#vmservicescrapespec)_ | false |
| `serviceSpec` | ServiceSpec that will be added to vmlogs service spec | _[AdditionalServiceSpec](#additionalservicespec)_ | false |
...
| `storageMetadata` | StorageMeta defines annotations and labels attached to PVC for given vmlogs CR | _[EmbeddedObjectMetadata](#embeddedobjectmetadata)_ | false |
