...
* BUGFIX: [vmalert](https://docs.victoriametrics.com/operator/resources/vmalert/): stop losing `VMRule` alert evaluation state and metrics whenever a large rule set's ConfigMap buckets were reshuffled. See [#2610](https://github.com/VictoriaMetrics/operator/issues/2610).
