...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMAuthJWTConfig) DeepCopyInto(out *VMAuthJWTConfig) {
	*out = *in
	...
	if in.JWKSEndpoints != nil {
		in, out := &in.JWKSEndpoints, &out.JWKSEndpoints
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.OIDCEndpoints != nil {
		in, out := &in.OIDCEndpoints, &out.OIDCEndpoints
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMAuthJWTConfig.
func (in *VMAuthJWTConfig) DeepCopy() *VMAuthJWTConfig {
	if in == nil {
		return nil
	}
	out := new(VMAuthJWTConfig)
	in.DeepCopyInto(out)
	return out
}
