...
Install VictoriaMetrics [operator](https://docs.victoriametrics.com/operator/quick-start/#operator)
Install VictoriaMetrics [storage](https://docs.victoriametrics.com/operator/quick-start/#storage)
Install VictoriaMetrics [agent and demo-app](https://docs.victoriametrics.com/operator/quick-start/#scraping)
