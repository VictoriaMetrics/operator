...
func simulateTargetEndpointsReady(ctx context.Context, c client.Client, namespace, serviceName string) {
...
func testWithDowntimeSingleNode(t *testing.T) {
	...
	simulateTargetEndpointsReady(ctx, c, ns, target.PrefixedName())
