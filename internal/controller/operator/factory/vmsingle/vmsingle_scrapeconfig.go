...
func (so *scrapeObjects) mustValidateObjects(cr *vmv1beta1.VMSingle) {
	var err error
...
func updateStatusesForScrapeObjects(ctx context.Context, rclient client.Client, cr *vmv1beta1.VMSingle, sos *scrapeObjects, childObject client.Object) error {
...
func setScrapeIntervalToWithLimit(ctx context.Context, dst *vmv1beta1.EndpointScrapeParams, cr *vmv1beta1.VMSingle) {
