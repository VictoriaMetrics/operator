...
// +kubebuilder:webhook:path=/validate-operator-victoriametrics-com-v1alpha1-VMDistributed,mutating=false,failurePolicy=fail,sideEffects=None,groups=operator.victoriametrics.com,resources=VMDistributeds,verbs=create;update,versions=v1alpha1,name=vVMDistributed-v1alpha1.kb.io,admissionReviewVersions=v1
