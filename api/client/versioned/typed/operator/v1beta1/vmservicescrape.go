...
type vMServiceScrapes struct {
	*gentype.ClientWithList[*v1beta1.VMServiceScrape, *v1beta1.VMServiceScrapeList]
}
...
func newVMServiceScrapes(c *OperatorV1beta1Client, namespace string) *vMServiceScrapes {
	return &vMServiceScrapes{
		gentype.NewClientWithList[*v1beta1.VMServiceScrape, *v1beta1.VMServiceScrapeList](
			"vmservicescrapes",
			c.RESTClient(),
