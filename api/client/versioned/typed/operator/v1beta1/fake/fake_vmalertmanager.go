...
var vmalertmanagersResource = v1beta1.SchemeGroupVersion.WithResource("vmalertmanagers")

var vmalertmanagersKind = v1beta1.SchemeGroupVersion.WithKind("VMAlertmanager")
...
func (c *FakeVMAlertmanagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMAlertmanager, err error) {
	emptyResult := &v1beta1.VMAlertmanager{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(vmalertmanagersResource, c.ns, name, options), emptyResult)
...
func (c *FakeVMAlertmanagers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMAlertmanagerList, err error) {
	emptyResult := &v1beta1.VMAlertmanagerList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(vmalertmanagersResource, vmalertmanagersKind, c.ns, opts), emptyResult)
...
func (c *FakeVMAlertmanagers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(vmalertmanagersResource, c.ns, opts))
...
func (c *FakeVMAlertmanagers) Create(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.CreateOptions) (result *v1beta1.VMAlertmanager, err error) {
	emptyResult := &v1beta1.VMAlertmanager{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(vmalertmanagersResource, c.ns, vMAlertmanager, opts), emptyResult)
...
func (c *FakeVMAlertmanagers) Update(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (result *v1beta1.VMAlertmanager, err error) {
	emptyResult := &v1beta1.VMAlertmanager{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(vmalertmanagersResource, c.ns, vMAlertmanager, opts), emptyResult)
...
func (c *FakeVMAlertmanagers) UpdateStatus(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (result *v1beta1.VMAlertmanager, err error) {
	emptyResult := &v1beta1.VMAlertmanager{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(vmalertmanagersResource, "status", c.ns, vMAlertmanager, opts), emptyResult)
...
func (c *FakeVMAlertmanagers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(vmalertmanagersResource, c.ns, opts, listOpts)
...
func (c *FakeVMAlertmanagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMAlertmanager, err error) {
	emptyResult := &v1beta1.VMAlertmanager{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(vmalertmanagersResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
