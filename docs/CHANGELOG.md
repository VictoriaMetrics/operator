...
* FEATURE: [config-reloader](https://github.com/VictoriaMetrics/operator/tree/master/cmd/config-reloader): exclude hidden directories from watch. It should prevent possible errors with hidden symlinks, which may occur during dir walk.
