...
func TestSelectServiceMonitors(t *testing.T) {
	...
	f := func(cr *vmv1beta1.VMAgent, want []string, predefinedObjects []runtime.Object) {
		...
		got, err := selectServiceScrapes(context.TODO(), cr, fclient)
		if err != nil {
		...
		if !reflect.DeepEqual(gotNames, want) {
			t.Errorf("SelectServiceScrapes() got = %v, want %v", gotNames, want)
		}
	}
	...
	}, []string{"default/default-monitor"}, []runtime.Object{
		&vmv1beta1.VMServiceScrape{
			ObjectMeta: metav1.ObjectMeta{
				Namespace: "default",
	...
	}, []string{"stg/default-monitor"}, []runtime.Object{
		&corev1.Namespace{
	...
	}, []string{}, defaultPredefinedObjects)
	...
	}, []string{"default/ss1", "default/ss2", "other1/ss1", "other1/ss2", "other2/ss1", "other2/ss2"}, defaultPredefinedObjects)
	...
	}, []string{"other1/ss1", "other1/ss2"}, defaultPredefinedObjects)
	...
	}, []string{"default/ss1"}, defaultPredefinedObjects)
	...
	}, []string{"other1/ss1"}, defaultPredefinedObjects)
	...
	}, []string{"other2/ss2"}, defaultPredefinedObjects)
}
