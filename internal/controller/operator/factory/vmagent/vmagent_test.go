...
func TestCreateOrUpdate_ServiceSpecs(t *testing.T) {
	f := func(cr *vmv1beta1.VMAgent, validate func(ctx context.Context, rclient client.Client, cr *vmv1beta1.VMAgent)) {
		t.Helper()
	...
	}, func(ctx context.Context, rclient client.Client, cr *vmv1beta1.VMAgent) {
