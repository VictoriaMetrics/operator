...
func Test_generateStaticScrapeConfig(t *testing.T) {
	f := func(cr *vmv1beta1.VMAgent, sc *vmv1beta1.VMStaticScrape, ep *vmv1beta1.TargetEndpoint, i int, want string, predefinedObjects []runtime.Object) {
		t.Helper()
		ctx := context.Background()
		fclient := k8stools.GetTestClientWithObjects(predefinedObjects)
		ac := getAssetsCache(ctx, fclient, cr)
		got, err := generateStaticScrapeConfig(ctx, cr, sc, ep, i, ac)
		if err != nil {
