...
If you're new to scraping metrics or VMAgent, we recommend starting with this article:
...
After that, continue with this quick start guide.
...
- [VMAuth](https://docs.victoriametrics.com/operator/resources/vmauth/) - receives HTTP requests, authenticate and routes them to the correct VictoriaMetrics resources.
