...
- target_label: endpoint
  replacement: "8080"
tls_config:
  ca_file: /etc/vm-tls/certs/default_tls-secret_ca
...
oauth2:
  ...
  tls_config:
    insecure_skip_verify: true
    ca_file: /etc/vm-tls/certs/default_configmap_tls-cm_ca
    cert_file: /etc/vm-tls/certs/default_tls_key
    key_file: /etc/vm-tls/certs/default_tls_cert
`,
	})
		...
		cr: &vmv1beta1.VMSingle{
			...
			Spec: vmv1beta1.VMSingleSpec{
				...
				APIServerConfig: &vmv1beta1.APIServerConfig{
					...
					TLSConfig: &vmv1beta1.TLSConfig{
						CAFile: "/etc/vm-tls/certs/default_k8s_host_ca",
					},
				},
			},
		},
...
- role: endpoints
  ...
  tls_config:
    ca_file: /etc/vm-tls/certs/default_k8s_host_ca
  selectors:
  - role: endpoints
...
tls_config:
  ...
  cert_file: /etc/vm-tls/certs/default_tls-secret_cert
`,
	})
