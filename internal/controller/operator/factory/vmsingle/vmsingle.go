...
func newPodSpec(ctx context.Context, cr *vmv1beta1.VMSingle) (*corev1.PodTemplateSpec, error) {
	...
	enableStrictSecurity := ptr.Deref(cr.Spec.UseStrictSecurity, cfg.EnableStrictSecurity)
	build.AddStrictSecuritySettingsToContainers(cr.Spec.SecurityContext, ic, enableStrictSecurity)
	...
	build.AddStrictSecuritySettingsToContainers(cr.Spec.SecurityContext, containers, enableStrictSecurity)
