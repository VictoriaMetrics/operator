...
var vmsinglesResource = schema.GroupVersionResource{Group: "victoriametrics.com", Version: "v1beta1", Resource: "vmsingles"}

var vmsinglesKind = schema.GroupVersionKind{Group: "victoriametrics.com", Version: "v1beta1", Kind: "VMSingle"}
...
func (c *FakeVMSingles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vmsinglesResource, c.ns, name), &v1beta1.VMSingle{})
