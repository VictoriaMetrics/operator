...
func (c *FakeVMAgents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMAgent, err error) {
	emptyResult := &v1beta1.VMAgent{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(vmagentsResource, c.ns, name, options), emptyResult)
...
func (c *FakeVMAgents) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMAgentList, err error) {
	emptyResult := &v1beta1.VMAgentList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(vmagentsResource, vmagentsKind, c.ns, opts), emptyResult)
...
func (c *FakeVMAgents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(vmagentsResource, c.ns, opts))
...
func (c *FakeVMAgents) Create(ctx context.Context, vMAgent *v1beta1.VMAgent, opts v1.CreateOptions) (result *v1beta1.VMAgent, err error) {
	emptyResult := &v1beta1.VMAgent{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(vmagentsResource, c.ns, vMAgent, opts), emptyResult)
...
func (c *FakeVMAgents) Update(ctx context.Context, vMAgent *v1beta1.VMAgent, opts v1.UpdateOptions) (result *v1beta1.VMAgent, err error) {
	emptyResult := &v1beta1.VMAgent{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(vmagentsResource, c.ns, vMAgent, opts), emptyResult)
...
func (c *FakeVMAgents) UpdateStatus(ctx context.Context, vMAgent *v1beta1.VMAgent, opts v1.UpdateOptions) (result *v1beta1.VMAgent, err error) {
	emptyResult := &v1beta1.VMAgent{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(vmagentsResource, "status", c.ns, vMAgent, opts), emptyResult)
...
func (c *FakeVMAgents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(vmagentsResource, c.ns, opts, listOpts)
...
func (c *FakeVMAgents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMAgent, err error) {
	emptyResult := &v1beta1.VMAgent{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(vmagentsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
