...
**Update note 8: VMProbe's spec.targets.ingress property is deprecated and will be removed in next releases. Use spec.targets.kubernetes instead.**
**Update note 9: VMProbe's spec.targets.staticConfig property is deprecated and will be removed in next releases. Use spec.targets.static instead.**
