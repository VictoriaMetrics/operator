...
* FEATURE: [vmoperator](https://docs.victoriametrics.com/operator/): added VM_CONFIG_RELOADER_EMPTY_DIR_SIZE global variable and `spec.configReloaderEmptyDir` parameter that allows to set emptyDir volume section for configurations volume. See [#1711](https://github.com/VictoriaMetrics/operator/issues/1711).
