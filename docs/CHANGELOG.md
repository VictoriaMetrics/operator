...
* BUGFIX: [vmoperator](https://docs.victoriametrics.com/operator/): replace DeepEqual with marshalled JSON specs compare. See [#2113](https://github.com/VictoriaMetrics/operator/issues/2113).
