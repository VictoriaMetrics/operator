...
func SetupVMProbeWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VMProbe{}).
		WithValidator(&VMProbeCustomValidator{}).
		Complete()
}
...
var _ admission.Validator[*vmv1beta1.VMProbe] = &VMProbeCustomValidator{}
...
func (*VMProbeCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VMProbe) (admission.Warnings, error) {
	return nil, nil
}
