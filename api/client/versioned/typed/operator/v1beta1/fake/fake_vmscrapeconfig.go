...
var vmscrapeconfigsResource = v1beta1.SchemeGroupVersion.WithResource("vmscrapeconfigs")

var vmscrapeconfigsKind = v1beta1.SchemeGroupVersion.WithKind("VMScrapeConfig")
...
func (c *FakeVMScrapeConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMScrapeConfig, err error) {
	emptyResult := &v1beta1.VMScrapeConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(vmscrapeconfigsResource, c.ns, name, options), emptyResult)

	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1beta1.VMScrapeConfig), err
}

// List takes label and field selectors, and returns the list of VMScrapeConfigs that match those selectors.
func (c *FakeVMScrapeConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMScrapeConfigList, err error) {
	emptyResult := &v1beta1.VMScrapeConfigList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(vmscrapeconfigsResource, vmscrapeconfigsKind, c.ns, opts), emptyResult)
	...
	list := &v1beta1.VMScrapeConfigList{ListMeta: obj.(*v1beta1.VMScrapeConfigList).ListMeta}
	for _, item := range obj.(*v1beta1.VMScrapeConfigList).Items {
...
func (c *FakeVMScrapeConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(vmscrapeconfigsResource, c.ns, opts))
...
func (c *FakeVMScrapeConfigs) Create(ctx context.Context, vMScrapeConfig *v1beta1.VMScrapeConfig, opts v1.CreateOptions) (result *v1beta1.VMScrapeConfig, err error) {
	emptyResult := &v1beta1.VMScrapeConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(vmscrapeconfigsResource, c.ns, vMScrapeConfig, opts), emptyResult)
...
func (c *FakeVMScrapeConfigs) Update(ctx context.Context, vMScrapeConfig *v1beta1.VMScrapeConfig, opts v1.UpdateOptions) (result *v1beta1.VMScrapeConfig, err error) {
	emptyResult := &v1beta1.VMScrapeConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(vmscrapeconfigsResource, c.ns, vMScrapeConfig, opts), emptyResult)
...
func (c *FakeVMScrapeConfigs) UpdateStatus(ctx context.Context, vMScrapeConfig *v1beta1.VMScrapeConfig, opts v1.UpdateOptions) (result *v1beta1.VMScrapeConfig, err error) {
	emptyResult := &v1beta1.VMScrapeConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(vmscrapeconfigsResource, "status", c.ns, vMScrapeConfig, opts), emptyResult)
...
func (c *FakeVMScrapeConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(vmscrapeconfigsResource, c.ns, name, opts), &v1beta1.VMScrapeConfig{})
...
func (c *FakeVMScrapeConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(vmscrapeconfigsResource, c.ns, opts, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.VMScrapeConfigList{})
	return err
}
...
func (c *FakeVMScrapeConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMScrapeConfig, err error) {
	emptyResult := &v1beta1.VMScrapeConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(vmscrapeconfigsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
