...
To install to ARM architecture you need to patch image versions, see [manager.arm.patch.yaml](./kustomize-example/manager.arm.patch.yaml) for example Deployment configuration.
