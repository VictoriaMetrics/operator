...
* Dependency: [vmoperator](https://docs.victoriametrics.com/operator/): Updated default versions for VM apps to [v1.141.0](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.141.0) version
...
* BUGFIX: [vmoperator](https://docs.victoriametrics.com/operator/): added TypedGenerationChangedPredicate filter to all controllers to prevent from frequent reconciles and compare JSONs instead of using DeepEqual. See [#2113](https://github.com/VictoriaMetrics/operator/issues/2113).
