...
* BUGFIX: [vmoperator](https://docs.victoriametrics.com/operator/): derive config-reloader ContainerPort, probes, scrape targets, and WaitForConfigReloadHash from configReloaderExtraArgs http.listenAddr instead of always using 8435. See [#2584](https://github.com/VictoriaMetrics/operator/issues/2584).
