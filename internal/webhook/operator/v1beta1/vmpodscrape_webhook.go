...
func SetupVMPodScrapeWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VMPodScrape{}).
...
var _ admission.Validator[*vmv1beta1.VMPodScrape] = &VMPodScrapeCustomValidator{}
...
func (*VMPodScrapeCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VMPodScrape) (admission.Warnings, error) {
	return nil, nil
}
