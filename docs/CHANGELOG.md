...
* Dependency: [vmoperator](https://docs.victoriametrics.com/operator/): Updated default versions for VMAnomaly to v1.30.3.
...
* FEATURE: [vmanomaly](https://docs.victoriametrics.com/operator/resources/vmanomaly/): add typed `spec.writer.batchMaxSeries`, `spec.writer.batchMaxBytes`, and `spec.writer.metricPrefixCacheMaxEntries` fields for the bounded writer controls introduced in vmanomaly v1.30.3.
