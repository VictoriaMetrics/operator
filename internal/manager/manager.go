...
var (
	...
	pprofAddr                     = flag.String("pprof-addr", "localhost:8435", "The address for pprof/debug API. Empty value disables server")
	probeAddr                     = flag.String("health-probe-bind-address", "localhost:8081", "The address the probes (health, ready) binds to.")
