...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMProbeTargetK8s) DeepCopyInto(out *VMProbeTargetK8s) {
	*out = *in
	in.Selector.DeepCopyInto(&out.Selector)
	in.NamespaceSelector.DeepCopyInto(&out.NamespaceSelector)
	if in.RelabelConfigs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMProbeTargetK8s.
func (in *VMProbeTargetK8s) DeepCopy() *VMProbeTargetK8s {
	if in == nil {
		return nil
	}
	out := new(VMProbeTargetK8s)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VMProbeTargets) DeepCopyInto(out *VMProbeTargets) {
	*out = *in
	...
	if in.K8s != nil {
		...
		*out = make([]*VMProbeTargetK8s, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VMProbeTargetK8s)
