...
// called with. Both the manager (real indexer registration) and the fake test client index
// on this same list, so a kind added or removed here takes effect in both places at once.
