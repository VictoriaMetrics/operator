...
func (in *VMAnomalyReadersSpec) DeepCopyInto(out *VMAnomalyReadersSpec) {
	*out = *in
	if in.VM != nil {
		in, out := &in.VM, &out.VM
		*out = make([]*VMAnomalyVMReaderSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMAnomalyVMReaderQuerySpec) DeepCopyInto(out *VMAnomalyVMReaderQuerySpec) {
	*out = *in
	if in.DataRange != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMAnomalyVMReaderQuerySpec.
func (in *VMAnomalyVMReaderQuerySpec) DeepCopy() *VMAnomalyVMReaderQuerySpec {
	if in == nil {
		return nil
	}
	out := new(VMAnomalyVMReaderQuerySpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VMAnomalyVMReaderSpec) DeepCopyInto(out *VMAnomalyVMReaderSpec) {
	*out = *in
	...
	if in.Queries != nil {
		...
		*out = make(map[string]*VMAnomalyVMReaderQuerySpec, len(*in))
		for key, val := range *in {
			var outVal *VMAnomalyVMReaderQuerySpec
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
func (in *VMAnomalyVMWriterSpec) DeepCopyInto(out *VMAnomalyVMWriterSpec) {
	*out = *in
	out.VMAnomalyVMWriterMetricFormatSpec = in.VMAnomalyVMWriterMetricFormatSpec
	in.VMAnomalyHTTPClientSpec.DeepCopyInto(&out.VMAnomalyHTTPClientSpec)
}
...
func (in *VMAnomalyWritersSpec) DeepCopyInto(out *VMAnomalyWritersSpec) {
	*out = *in
	if in.VM != nil {
		in, out := &in.VM, &out.VM
		*out = make([]*VMAnomalyVMWriterSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VMAnomalyVMWriterSpec)
