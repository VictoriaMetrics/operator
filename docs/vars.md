...
<!-- this doc autogenerated - don't edit it manually -->
 updated at Tue Sep 17 20:10:47 UTC 2024
...
| VM_CLUSTERDOMAINNAME | - | false | Defines domain name suffix for in-cluster addressesmost known ClusterDomainName is .cluster.local |
| VM_APPREADYTIMEOUT | 80s | false | Defines deadline for deploymnet/statefulsetto transit into ready stateto wait for transition to ready state |
| VM_PODWAITREADYTIMEOUT | 80s | false | Defines single pod deadlineto wait for transition to ready state |
| VM_PODWAITREADYINTERVALCHECK | 5s | false | Defines poll interval for pods ready checkat statefulset rollout update |
...
[envconfig-sum]: 0cf8f1edefa0f4647a201bf19834698c