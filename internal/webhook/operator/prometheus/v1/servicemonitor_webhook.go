...
// +kubebuilder:webhook:path=/validate-monitoring-coreos-com-v1-servicemonitor,mutating=false,failurePolicy=fail,sideEffects=None,groups=monitoring.coreos.com,resources=servicemonitors,verbs=create;update;patch,versions=v1,name=vservicemonitor-v1.kb.io,admissionReviewVersions=v1
