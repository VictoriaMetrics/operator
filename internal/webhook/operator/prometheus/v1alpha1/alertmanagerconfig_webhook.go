...
// +kubebuilder:webhook:path=/validate-monitoring-coreos-com-v1alpha1-alertmanagerconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=monitoring.coreos.com,resources=alertmanagerconfigs,verbs=create;update;patch,versions=v1alpha1,name=valertmanagerconfig-v1alpha1.kb.io,admissionReviewVersions=v1
