...
var vmalertmanagersResource = schema.GroupVersionResource{Group: "victoriametrics.com", Version: "v1beta1", Resource: "vmalertmanagers"}

var vmalertmanagersKind = schema.GroupVersionKind{Group: "victoriametrics.com", Version: "v1beta1", Kind: "VMAlertmanager"}
...
func (c *FakeVMAlertmanagers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vmalertmanagersResource, c.ns, name), &v1beta1.VMAlertmanager{})
