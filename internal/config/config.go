...
type BaseOperatorConf struct {
	...
	VLogsDefault struct {
		...
		Version string `default:"v1.6.1-victorialogs"`
		// ignored
	...
	VMAlertDefault struct {
		...
		Version             string `default:"v1.111.0"`
	...
	VMClusterDefault struct {
		...
		VMSelectDefault     struct {
			...
			Version  string `default:"v1.111.0-cluster"`
	...
	VMBackup                         struct {
		...
		Version             string `default:"v1.111.0-enterprise"`
