...
type VMPodScrapeLister interface {
	...
	List(selector labels.Selector) (ret []*operatorv1beta1.VMPodScrape, err error)
...
type vMPodScrapeLister struct {
	listers.ResourceIndexer[*operatorv1beta1.VMPodScrape]
}

// NewVMPodScrapeLister returns a new VMPodScrapeLister.
func NewVMPodScrapeLister(indexer cache.Indexer) VMPodScrapeLister {
	return &vMPodScrapeLister{listers.New[*operatorv1beta1.VMPodScrape](indexer, operatorv1beta1.Resource("vmpodscrape"))}
}

// VMPodScrapes returns an object that can list and get VMPodScrapes.
func (s *vMPodScrapeLister) VMPodScrapes(namespace string) VMPodScrapeNamespaceLister {
	return vMPodScrapeNamespaceLister{listers.NewNamespaced[*operatorv1beta1.VMPodScrape](s.ResourceIndexer, namespace)}
}
...
type VMPodScrapeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*operatorv1beta1.VMPodScrape, error)
