...
func addWebhooks(mgr ctrl.Manager) error {
	...
	return f([]func(ctrl.Manager) error{
		...
		webhookv1.SetupVMAnomalyOneoffSchedulerWebhookWithManager,
		webhookv1.SetupVMAnomalyPeriodicSchedulerWebhookWithManager,
		webhookv1.SetupVMAnomalyBacktestingSchedulerWebhookWithManager,
		webhookv1.SetupVMAnomalyAutoTunedModelWebhookWithManager,
		webhookv1.SetupVMAnomalyHoltWintersModelWebhookWithManager,
		webhookv1.SetupVMAnomalyIsolationForestModelWebhookWithManager,
		webhookv1.SetupVMAnomalyIsolationForestMultivariateModelWebhookWithManager,
		webhookv1.SetupVMAnomalyMadModelWebhookWithManager,
		webhookv1.SetupVMAnomalyOnlineMadModelWebhookWithManager,
		webhookv1.SetupVMAnomalyOnlineQuantileModelWebhookWithManager,
		webhookv1.SetupVMAnomalyOnlineZScoreModelWebhookWithManager,
		webhookv1.SetupVMAnomalyProphetModelWebhookWithManager,
		webhookv1.SetupVMAnomalyRollingQuantileModelWebhookWithManager,
		webhookv1.SetupVMAnomalyStdModelWebhookWithManager,
		webhookv1.SetupVMAnomalyZScoreModelWebhookWithManager,
		webhookv1.SetupVMAnomalyVMReaderWebhookWithManager,
		webhookv1.SetupVMAnomalyVMWriterWebhookWithManager,
...
var controllersByName = map[string]crdController{
	...
	"VMAnomalyAutoTunedModel":       &vmcontroller.VMAnomalyAutoTunedModelReconciler{},
	"VMAnomalyHoltWintersModel":     &vmcontroller.VMAnomalyHoltWintersModelReconciler{},
	"VMAnomalyIsolationForestModel": &vmcontroller.VMAnomalyIsolationForestModelReconciler{},
	"VMAnomalyIsolationForestMultivariateModel": &vmcontroller.VMAnomalyIsolationForestMultivariateModelReconciler{},
	"VMAnomalyMadModel":                         &vmcontroller.VMAnomalyMadModelReconciler{},
	"VMAnomalyOnlineMadModel":                   &vmcontroller.VMAnomalyOnlineMadModelReconciler{},
	"VMAnomalyOnlineQuantileModel":              &vmcontroller.VMAnomalyOnlineQuantileModelReconciler{},
	"VMAnomalyOnlineZScoreModel":                &vmcontroller.VMAnomalyOnlineZScoreModelReconciler{},
	"VMAnomalyProphetModel":                     &vmcontroller.VMAnomalyProphetModelReconciler{},
	"VMAnomalyRollingQuantileModel":             &vmcontroller.VMAnomalyRollingQuantileModelReconciler{},
	"VMAnomalyStdModel":                         &vmcontroller.VMAnomalyStdModelReconciler{},
	"VMAnomalyZScoreModel":                      &vmcontroller.VMAnomalyZScoreModelReconciler{},
	"VMAnomalyVMReader":                         &vmcontroller.VMAnomalyVMReaderReconciler{},
	"VMAnomalyVMWriter":                         &vmcontroller.VMAnomalyVMWriterReconciler{},
	"VMAnomalyOneoffScheduler":                  &vmcontroller.VMAnomalyOneoffSchedulerReconciler{},
	"VMAnomalyBacktestingScheduler":             &vmcontroller.VMAnomalyBacktestingSchedulerReconciler{},
	"VMAnomalyPeriodicScheduler":                &vmcontroller.VMAnomalyPeriodicSchedulerReconciler{},
