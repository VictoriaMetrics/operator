...
// queueMetricName is vlagent's persistent-queue gauge (see
// https://docs.victoriametrics.com/victorialogs/vlagent-metrics/).
const queueMetricName = "vlagent_remotewrite_pending_data_bytes"
