...
func (in *VLogsStatus) DeepCopyInto(out *VLogsStatus) {
	*out = *in
	out.StatusMetadata = in.StatusMetadata
}
...
func (in *VMAuthSpec) DeepCopyInto(out *VMAuthSpec) {
	*out = *in
	...
	if in.UnauthorizedUserAccess != nil {
		in, out := &in.UnauthorizedUserAccess, &out.UnauthorizedUserAccess
		*out = new(VMAuthUnauthorizedUserAccess)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMAuthUnauthorizedUserAccess) DeepCopyInto(out *VMAuthUnauthorizedUserAccess) {
	*out = *in
	if in.URLPrefix != nil {
		in, out := &in.URLPrefix, &out.URLPrefix
		*out = make(StringOrArray, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMAuthUnauthorizedUserAccess.
func (in *VMAuthUnauthorizedUserAccess) DeepCopy() *VMAuthUnauthorizedUserAccess {
	if in == nil {
		return nil
	}
	out := new(VMAuthUnauthorizedUserAccess)
