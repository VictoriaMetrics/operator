...
func SetupVLogsWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VLogs{}).
...
var _ admission.Validator[*vmv1beta1.VLogs] = &VLogsCustomValidator{}
...
func (*VLogsCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VLogs) (admission.Warnings, error) {
	return nil, nil
}
