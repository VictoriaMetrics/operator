...
func CreateOrUpdateShardedDeploy(ctx context.Context, rclient client.Client, cr, prevCR shardOpts, newDeploy, prevDeploy runtime.Object) error {
	...
	for shardNum := range shardNumIter(isUpscaling, shardCount) {
		...
		case *appsv1.StatefulSet:
			...
			statefulSetOpts := reconcile.StatefulSetOptions{
			...
			if err := reconcile.HandleStatefulSetUpdate(ctx, rclient, statefulSetOpts, shardedDeploy, prevStatefulSet); err != nil {
				return err
			}
	...
	if err := finalize.RemoveOrphanedDaemonSet(ctx, rclient, cr.PrefixedName(), cr.GetNamespace()); err != nil {
		return err
	}
	return nil
}
...
func CreateOrUpdateDeploy(ctx context.Context, rclient client.Client, cr, _ deployOpts, newDeploy, prevObjectSpec runtime.Object) error {
	...
	case *appsv1.StatefulSet:
		...
		if err := reconcile.HandleStatefulSetUpdate(ctx, rclient, statefulSetOpts, newDeploy, prevStatefulSet); err != nil {
			return err
		}
