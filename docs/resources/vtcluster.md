...
You can see the full actual specification of the `VTCluster` resource in the **[API docs -> VTCluster](https://docs.victoriametrics.com/operator/api/#v1-vtcluster)**.
...
## Requests Load-Balancing
 ...
 Operator allows to tweak Kubernetes TCP-based load-balancing with enabled [requestsLoadBalancer](https://docs.victoriametrics.com/operator/api/#v1-vtclusterspec-requestsloadbalancer):
