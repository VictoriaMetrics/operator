...
func SetupVMAgentWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VMAgent{}).
...
var _ admission.Validator[*vmv1beta1.VMAgent] = &VMAgentCustomValidator{}

// ValidateCreate implements admission.Validator so a webhook will be registered for the type
func (*VMAgentCustomValidator) ValidateCreate(_ context.Context, obj *vmv1beta1.VMAgent) (admission.Warnings, error) {
...
func (*VMAgentCustomValidator) ValidateUpdate(_ context.Context, _, newObj *vmv1beta1.VMAgent) (admission.Warnings, error) {
...
func (*VMAgentCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VMAgent) (admission.Warnings, error) {
	return nil, nil
}
