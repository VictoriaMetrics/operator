...
func selectScrapeConfig(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMScrapeConfig, error) {
...
func selectPodScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMPodScrape, error) {
...
func selectVMProbes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMProbe, error) {
...
func selectVMNodeScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMNodeScrape, error) {
...
func selectStaticScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMStaticScrape, error) {
...
func selectServiceScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMServiceScrape, error) {
