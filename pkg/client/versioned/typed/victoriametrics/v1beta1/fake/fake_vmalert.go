...
var vmalertsResource = schema.GroupVersionResource{Group: "victoriametrics.com", Version: "v1beta1", Resource: "vmalerts"}

var vmalertsKind = schema.GroupVersionKind{Group: "victoriametrics.com", Version: "v1beta1", Kind: "VMAlert"}
...
func (c *FakeVMAlerts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vmalertsResource, c.ns, name), &v1beta1.VMAlert{})
