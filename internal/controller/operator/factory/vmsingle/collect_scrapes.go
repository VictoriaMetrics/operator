...
func selectScrapeConfigs(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMScrapeConfig, []string, error) {
...
func selectPodScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMPodScrape, []string, error) {
...
func selectProbes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMProbe, []string, error) {
...
func selectNodeScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMNodeScrape, []string, error) {
	if !config.IsClusterWideAccessAllowed() && cr.IsOwnsServiceAccount() {
		logger.WithContext(ctx).Info("cannot use VMNodeScrape at operator in single namespace mode with default permissions." +
			" Create ServiceAccount for VMSingle manually if needed. Skipping config generation for it")
		return nil, nil, nil
	}
...
func selectStaticScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMStaticScrape, []string, error) {
...
func selectServiceScrapes(ctx context.Context, cr *vmv1beta1.VMSingle, rclient client.Client) ([]*vmv1beta1.VMServiceScrape, []string, error) {
