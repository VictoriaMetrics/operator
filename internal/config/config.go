...
type BaseOperatorConf struct {
	...
	CustomConfigReloaderImage string `default:"victoriametrics/operator:config-reloader-v0.31.1"`
	PSPAutoCreateEnabled      bool   `default:"true"`
	VMAlertDefault            struct {
		Image               string `default:"victoriametrics/vmalert"`
		Version             string `default:"v1.85.3"`
	...
	VMClusterDefault struct {
		...
		VMSelectDefault     struct {
			...
			Version  string `default:"v1.85.3-cluster"`
	...
	VMBackup                         struct {
		...
		Version             string `default:"v1.85.3-enterprise"`
