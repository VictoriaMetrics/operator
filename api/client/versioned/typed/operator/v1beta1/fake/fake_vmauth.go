...
func (c *FakeVMAuths) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMAuth, err error) {
	emptyResult := &v1beta1.VMAuth{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(vmauthsResource, c.ns, name, options), emptyResult)
...
func (c *FakeVMAuths) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMAuthList, err error) {
	emptyResult := &v1beta1.VMAuthList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(vmauthsResource, vmauthsKind, c.ns, opts), emptyResult)
...
func (c *FakeVMAuths) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(vmauthsResource, c.ns, opts))
...
func (c *FakeVMAuths) Create(ctx context.Context, vMAuth *v1beta1.VMAuth, opts v1.CreateOptions) (result *v1beta1.VMAuth, err error) {
	emptyResult := &v1beta1.VMAuth{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(vmauthsResource, c.ns, vMAuth, opts), emptyResult)
...
func (c *FakeVMAuths) Update(ctx context.Context, vMAuth *v1beta1.VMAuth, opts v1.UpdateOptions) (result *v1beta1.VMAuth, err error) {
	emptyResult := &v1beta1.VMAuth{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(vmauthsResource, c.ns, vMAuth, opts), emptyResult)
...
func (c *FakeVMAuths) UpdateStatus(ctx context.Context, vMAuth *v1beta1.VMAuth, opts v1.UpdateOptions) (result *v1beta1.VMAuth, err error) {
	emptyResult := &v1beta1.VMAuth{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(vmauthsResource, "status", c.ns, vMAuth, opts), emptyResult)
...
func (c *FakeVMAuths) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(vmauthsResource, c.ns, opts, listOpts)
...
func (c *FakeVMAuths) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMAuth, err error) {
	emptyResult := &v1beta1.VMAuth{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(vmauthsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
