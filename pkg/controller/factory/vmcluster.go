...
func makePodSpecForVMSelect(cr *v1beta1.VMCluster, c *conf.BaseOperatorConf) (*corev1.PodTemplateSpec, error) {
	...
	if cr.Spec.VMSelect.LogLevel != "" {
		args = append(args, fmt.Sprintf("-loggerFormat=%s", cr.Spec.VMSelect.LogLevel))
	}
...
func makePodSpecForVMInsert(cr *v1beta1.VMCluster, c *conf.BaseOperatorConf) (*corev1.PodTemplateSpec, error) {
	...
	if cr.Spec.VMInsert.LogLevel != "" {
		args = append(args, fmt.Sprintf("-loggerFormat=%s", cr.Spec.VMInsert.LogLevel))
	}
...
func makePodSpecForVMStorage(cr *v1beta1.VMCluster) (*corev1.PodTemplateSpec, error) {
	...
	if cr.Spec.VMStorage.LogLevel != "" {
		args = append(args, fmt.Sprintf("-loggerFormat=%s", cr.Spec.VMStorage.LogLevel))
	}
