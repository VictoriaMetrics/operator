...
`,
	...
	f(opts{
		...
		want: `job_name: probe/monitor/probe-httproute
honor_labels: false
metrics_path: /probe
params:
  module:
...
- source_labels:
  ...
  separator: ;
  regex: (.*)
  target_label: __tmp_httproute_address
  replacement: $1
  action: replace
- source_labels:
  - __meta_kubernetes_httproute_scheme
  - __address__
...
- source_labels:
  ...
  target_label: namespace
- source_labels:
  - __meta_kubernetes_httproute_name
...
`,
	...
	f(opts{
		...
		want: `job_name: probe/monitor/probe-grpcroute
honor_labels: false
metrics_path: /probe
params:
  module:
...
relabel_configs:
- action: replace
  target_label: __meta_kubernetes_grpcroute_path
  replacement: ""
- source_labels:
  - __address__
  separator: ;
  regex: (.*)
  target_label: __tmp_grpcroute_address
  replacement: $1
  action: replace
- source_labels:
  - __meta_kubernetes_grpcroute_scheme
  - __address__
  - __meta_kubernetes_grpcroute_path
  separator: ;
  regex: (.+);(.+);(.+)
  target_label: __param_target
  replacement: ${1}://${2}${3}
...
- source_labels:
  ...
  target_label: namespace
- source_labels:
  - __meta_kubernetes_grpcroute_name
  target_label: grpcroute
- source_labels:
  - label1
  target_label: api
  action: replacement
