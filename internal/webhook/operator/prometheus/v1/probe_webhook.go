...
// +kubebuilder:webhook:path=/validate-monitoring-coreos-com-v1-probe,mutating=false,failurePolicy=fail,sideEffects=None,groups=monitoring.coreos.com,resources=probes,verbs=create;update;patch,versions=v1,name=vprobe-v1.kb.io,admissionReviewVersions=v1
