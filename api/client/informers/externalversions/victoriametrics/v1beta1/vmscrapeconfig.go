	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VictoriametricsV1beta1().VMScrapeConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VictoriametricsV1beta1().VMScrapeConfigs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *vMScrapeConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&victoriametricsv1beta1.VMScrapeConfig{}, f.defaultInformer)
}
