...
func SetupVMAlertWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VMAlert{}).
...
var _ admission.Validator[*vmv1beta1.VMAlert] = &VMAlertCustomValidator{}

// ValidateCreate implements admission.Validator so a webhook will be registered for the type
func (*VMAlertCustomValidator) ValidateCreate(_ context.Context, obj *vmv1beta1.VMAlert) (admission.Warnings, error) {
...
func (*VMAlertCustomValidator) ValidateUpdate(_ context.Context, _, newObj *vmv1beta1.VMAlert) (admission.Warnings, error) {
...
func (*VMAlertCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VMAlert) (admission.Warnings, error) {
	return nil, nil
}
