...
* FEATURE: [vmprobe](https://docs.victoriametrics.com/operator/resources/vmprobe/): added `spec.targets.k8s` property, that allows to configure probe for `ingress`, `pod`, `service`, `httproute` and `grpcroute` roles. See [#1282](https://github.com/VictoriaMetrics/operator/issues/1282), [#1078](https://github.com/VictoriaMetrics/operator/issues/1078) and [#1716](https://github.com/VictoriaMetrics/operator/issues/1716).
