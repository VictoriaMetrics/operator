...
func (c *OperatorV1alpha1Client) VMDistributedClusters(namespace string) VMDistributedClusterInterface {
	return newVMDistributedClusters(c, namespace)
}
