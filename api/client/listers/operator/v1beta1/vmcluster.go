...
type VMClusterLister interface {
	...
	List(selector labels.Selector) (ret []*operatorv1beta1.VMCluster, err error)
...
type vMClusterLister struct {
	listers.ResourceIndexer[*operatorv1beta1.VMCluster]
}

// NewVMClusterLister returns a new VMClusterLister.
func NewVMClusterLister(indexer cache.Indexer) VMClusterLister {
	return &vMClusterLister{listers.New[*operatorv1beta1.VMCluster](indexer, operatorv1beta1.Resource("vmcluster"))}
}

// VMClusters returns an object that can list and get VMClusters.
func (s *vMClusterLister) VMClusters(namespace string) VMClusterNamespaceLister {
	return vMClusterNamespaceLister{listers.NewNamespaced[*operatorv1beta1.VMCluster](s.ResourceIndexer, namespace)}
}
...
type VMClusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*operatorv1beta1.VMCluster, error)
