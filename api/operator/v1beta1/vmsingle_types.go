...
func (cr *VMSingle) Validate() error {
	...
	if err := ValidateServiceSpecs(cr.PrefixedName(), cr.Spec.ServiceSpec, cr.Spec.ServiceSpecs, SimplePortNameSet(append([]string{"http-alias", "vmbackupmanager"}, insertPortNames...)...)); err != nil {
		return err
	}
