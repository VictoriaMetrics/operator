...
type VMNodeScrapeLister interface {
	...
	List(selector labels.Selector) (ret []*operatorv1beta1.VMNodeScrape, err error)
...
type vMNodeScrapeLister struct {
	listers.ResourceIndexer[*operatorv1beta1.VMNodeScrape]
}
...
func NewVMNodeScrapeLister(indexer cache.Indexer) VMNodeScrapeLister {
	return &vMNodeScrapeLister{listers.New[*operatorv1beta1.VMNodeScrape](indexer, operatorv1beta1.Resource("vmnodescrape"))}
}

// VMNodeScrapes returns an object that can list and get VMNodeScrapes.
func (s *vMNodeScrapeLister) VMNodeScrapes(namespace string) VMNodeScrapeNamespaceLister {
	return vMNodeScrapeNamespaceLister{listers.NewNamespaced[*operatorv1beta1.VMNodeScrape](s.ResourceIndexer, namespace)}
}
...
type VMNodeScrapeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*operatorv1beta1.VMNodeScrape, error)
