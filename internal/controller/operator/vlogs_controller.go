...
// +kubebuilder:rbac:groups=operator.victoriametrics.com,resources=vmlogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.victoriametrics.com,resources=vmlogs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=operator.victoriametrics.com,resources=vmlogs/finalizers,verbs=*
...
func (r *VLogsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, err error) {
	reqLogger := r.Log.WithValues("vlogs", req.NamespacedName)
	...
	return reconcileAndTrackStatus(ctx, r.Client, instance, func() (ctrl.Result, error) {
		...
		if err = vlogs.CreateOrUpdateVLogs(ctx, instance, r, r.BaseConf); err != nil {
