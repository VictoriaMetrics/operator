...
func TestConvertAlertmanagerConfig(t *testing.T) {
	f := func(cfg *promv1alpha1.AlertmanagerConfig, validate func(convertedAMCfg *vmv1beta1.VMAlertmanagerConfig) error) {
		t.Helper()
		converted, err := ConvertAlertmanagerConfig(cfg, &config.BaseOperatorConf{})
		if err != nil {
	...
	// simple convert
	f(&promv1alpha1.AlertmanagerConfig{
...
func TestConvertScrapeConfig(t *testing.T) {
	f := func(cfg *promv1alpha1.ScrapeConfig, ownerRef bool, want vmv1beta1.VMScrapeConfig) {
		t.Helper()
		got := ConvertScrapeConfig(cfg, &config.BaseOperatorConf{EnabledPrometheusConverterOwnerReferences: ownerRef})
	...
	}, false, vmv1beta1.VMScrapeConfig{
