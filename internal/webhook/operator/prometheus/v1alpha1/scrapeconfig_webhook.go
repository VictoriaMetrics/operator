...
// +kubebuilder:webhook:path=/validate-monitoring-coreos-com-v1alpha1-scrapeconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=monitoring.coreos.com,resources=scrapeconfigs,verbs=create;update,versions=v1alpha1,name=vscrapeconfig-v1alpha1.kb.io,admissionReviewVersions=v1
