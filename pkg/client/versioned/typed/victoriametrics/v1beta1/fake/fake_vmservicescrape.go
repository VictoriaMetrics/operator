...
var vmservicescrapesResource = schema.GroupVersionResource{Group: "victoriametrics.com", Version: "v1beta1", Resource: "vmservicescrapes"}

var vmservicescrapesKind = schema.GroupVersionKind{Group: "victoriametrics.com", Version: "v1beta1", Kind: "VMServiceScrape"}
...
func (c *FakeVMServiceScrapes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vmservicescrapesResource, c.ns, name), &v1beta1.VMServiceScrape{})
