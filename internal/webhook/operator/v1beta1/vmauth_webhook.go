...
func SetupVMAuthWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &vmv1beta1.VMAuth{}).
...
var _ admission.Validator[*vmv1beta1.VMAuth] = &VMAuthCustomValidator{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (*VMAuthCustomValidator) ValidateCreate(_ context.Context, obj *vmv1beta1.VMAuth) (admission.Warnings, error) {
...
func (*VMAuthCustomValidator) ValidateUpdate(_ context.Context, _, newObj *vmv1beta1.VMAuth) (admission.Warnings, error) {
...
func (*VMAuthCustomValidator) ValidateDelete(_ context.Context, _ *vmv1beta1.VMAuth) (admission.Warnings, error) {
	return nil, nil
}
