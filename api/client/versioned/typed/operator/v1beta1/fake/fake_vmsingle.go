...
func (c *FakeVMSingles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMSingle, err error) {
	emptyResult := &v1beta1.VMSingle{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(vmsinglesResource, c.ns, name, options), emptyResult)
...
func (c *FakeVMSingles) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMSingleList, err error) {
	emptyResult := &v1beta1.VMSingleList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(vmsinglesResource, vmsinglesKind, c.ns, opts), emptyResult)
...
func (c *FakeVMSingles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(vmsinglesResource, c.ns, opts))
...
func (c *FakeVMSingles) Create(ctx context.Context, vMSingle *v1beta1.VMSingle, opts v1.CreateOptions) (result *v1beta1.VMSingle, err error) {
	emptyResult := &v1beta1.VMSingle{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(vmsinglesResource, c.ns, vMSingle, opts), emptyResult)
...
func (c *FakeVMSingles) Update(ctx context.Context, vMSingle *v1beta1.VMSingle, opts v1.UpdateOptions) (result *v1beta1.VMSingle, err error) {
	emptyResult := &v1beta1.VMSingle{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(vmsinglesResource, c.ns, vMSingle, opts), emptyResult)
...
func (c *FakeVMSingles) UpdateStatus(ctx context.Context, vMSingle *v1beta1.VMSingle, opts v1.UpdateOptions) (result *v1beta1.VMSingle, err error) {
	emptyResult := &v1beta1.VMSingle{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(vmsinglesResource, "status", c.ns, vMSingle, opts), emptyResult)
...
func (c *FakeVMSingles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(vmsinglesResource, c.ns, opts, listOpts)
...
func (c *FakeVMSingles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMSingle, err error) {
	emptyResult := &v1beta1.VMSingle{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(vmsinglesResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
