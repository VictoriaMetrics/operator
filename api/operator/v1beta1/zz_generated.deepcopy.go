...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastAppliedMetadata) DeepCopyInto(out *LastAppliedMetadata) {
	*out = *in
	if in.Annotations != nil {
		in, out := &in.Annotations, &out.Annotations
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastAppliedMetadata.
func (in *LastAppliedMetadata) DeepCopy() *LastAppliedMetadata {
	if in == nil {
		return nil
	}
	out := new(LastAppliedMetadata)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VLogs) DeepCopyInto(out *VLogs) {
	*out = *in
	...
	in.ParsedLastAppliedMetadata.DeepCopyInto(&out.ParsedLastAppliedMetadata)
