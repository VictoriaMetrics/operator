...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("vtagents"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1().VTAgents().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("vldistributeds"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1alpha1().VLDistributeds().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("vmdistributed"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1alpha1().VMDistributed().Informer()}, nil
